        ...
        pets = [
            {
                ...
                "birth": "2022-12-01",
                "type": {"name": "モモンガ"},
                "breed": {"name": "パプアフクロモモンガ", "type_id": self.type.id},
                "customer_id": self.customer.id,
                "weight": 44,
            },
            {
                ...
                "birth": "2022-12-01",
                "type": {"name": "モモンガ"},
                "breed": {"name": "オブトフクロモモンガ", "type_id": self.type.id},
                "customer_id": self.customer.id,
                "weight": 44,
            },
            {
                ...
                "birth": "2022-12-01",
                "type": {"name": "リス"},
                "breed": {"name": "エゾリス", "type_id": self.type.id},
                "customer_id": self.customer.id,
                "weight": 44,
            },
        ]
    ...
    def test_get_pet_breed_filter(self):
        ...
        pets = [
            ...
            },
            {
                ...
                "sex": True,
                "birth": "2022-12-01",
                "type": {"name": "モモンガ", "type_id": self.type.id},
                "breed": {"name": "オブトフクロモモンガ", "type_id": self.type.id},
                "customer_id": self.customer.id,
                "weight": 44,
            },
        ...
        data = res.data["results"]
        pets = [pet for pet in pets if pet["breed"]["name"] == "パプアフクロモモンガ"]
        pets.reverse()
        self.assertEqual(res.status_code, status.HTTP_200_OK)
