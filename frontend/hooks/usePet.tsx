import {PET_BREEDS, PET_STAT, PET_TYPES, PETS} from "@constants/queryKeys";
import {PetBreedInterface, PetsInterface, PetTypeInterface, QueryInterface,} from "@interfaces/cmsInterfaces";
...
async function getPets({query, token, typeFilter, breedFilter, customerFilter}: {
...
async function getPetStat({token}: {
    token?: string;
