...
export default function CustomerMemoPanel({
  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap w-full gap-2 p-4 overflow-auto transition bg-yellow-50 max-h-[100%]">
        {memos.map((memo) => (
          <div
          ...
          >
            ...
            <div className="p-2 text-center duration-500 rounded-md select-none group-hover:bg-error bg-orange-50 text-neutral hover:bg-error active:bg-error">
              {memo.memo}
            </div>
          </div>
        ))}
